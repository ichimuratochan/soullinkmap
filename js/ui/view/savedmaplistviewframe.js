var SavedMapListViewFrame = function(){this.initialize.apply(this, arguments);}
SavedMapListViewFrame.prototype = toolBox.extend(new ModalDialogFrame(), {
    minWidth    : 500
,   minHeight   : 233
,   initialize: function(_containerShape, _parentShape, _defaultLayer, _callBackTarget, _arg1, _arg2, _arg3, _arg4, _arg5) {
        ModalDialogFrame.prototype.initialize.apply(this,[_containerShape, _parentShape, _defaultLayer, 0, 0, 0, 0, false, false]);
        this.classType = 'SavedMapListViewFrame';
        this.text = translator.t('ブラウザのストレージに保存されたMAP一覧');

        this.setActualW(this.minWidth);
        this.setActualH(this.minHeight);
        this.centerize();

        this.view = new SavedMapListView(
            _containerShape,
            this,
            _defaultLayer,
...
,   callBackFromShapeTransferAnimation: function(_arg1, _arg2, _arg3, _arg4, _arg5) {
        ...
        this.visible = true;
        this.registerDrawBuffer();
        this.soulMaster.savedMapListBox = this;
    }
,   save: function() {
        this.view.save();
    }
