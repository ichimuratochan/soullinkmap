var FontSettingBoxFrame = function(){this.initialize.apply(this, arguments);}
FontSettingBoxFrame.prototype = toolBox.extend(new ModalDialogFrame(), {
    minHeight   : 233
,   minWidth    : 210
,   initialize: function(_containerShape, _parentShape, _defaultLayer, _callBackTarget, _defaultTextFont, _arg1, _arg2, _arg3, _arg4, _arg5) {
        ModalDialogFrame.prototype.initialize.apply(this,[_containerShape, _parentShape, _defaultLayer, 0, 0, 0, 0, false, false]);
        this.classType = 'FontSettingBoxFrame';
        this.text = translator.t('フォント設定');

        this.setActualW(this.minWidth);
        this.setActualH(this.minHeight);
        this.centerize();

        this.view = new FontSettingBox(
            _containerShape,
            this,
            _defaultLayer,
